...
const Carousel = () => {
  return (
    ...
    <div style={{height:'400px'}} id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" data-interval="1000">
        ...
        <div style={{ objectFit: 'cover', height: '400px' }} className="carousel-inner">
          <div className="carousel-item active">
            <img  style={{ height:'400px' , objectFit:'cover'}} className="d-block w-100" src="img1.jpg" alt="First slide" />
          ...
          <div className="carousel-item">
            <img style={{ height:'400px' , objectFit:'cover'}} className="d-block w-100" src="img1.jpg" alt="Second slide" />
            <div className="carousel-caption d-none d-md-block text-left align-items-center d-flex h-100">
              <h2 style={{marginTop:'100px'}}>KNOW YOUR RIGHTS</h2>
              <Link to={"/knowyourrights"}><p style={{color:'white'}}>As a citizen of India know what are your lega rights! &rarr;</p></Link>

            </div>
          </div>
          <div className="carousel-item">
            <img style={{ height:'400px' , objectFit:'cover'}} className="d-block w-100" src="img1.jpg" alt="Third slide" />
            <div className="carousel-caption d-none d-md-block text-left align-items-center d-flex h-100">
